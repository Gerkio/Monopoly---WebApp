...
var I18N = (function () {
	...
	var dict = {
		en: {
			...
			// Setup
			'setup.welcomeTitle': 'MONOPOLY',
			'setup.welcomeTagline': 'The timeless classic · Digital edition',
			...
			'setup.customizeFor': 'Customize — {player}',
			'setup.customizeDone': 'Done',
			...
			'setup.presetsLabel': 'Starting cash:',
			'setup.editionClassicDesc': 'Boardwalk · Mediterranean · 1935',
			'setup.editionNYCDesc': 'Times Square · Wall Street · Modern',
			'setup.startGameHero': 'PLAY',
			'setup.startGameSubtitle': 'Start a new game',
			'setup.aiHumanDesc': 'Real player',
			'setup.aiEasyDesc': 'Learning',
			'setup.aiNormalDesc': 'Balanced',
			'setup.aiHardDesc': 'Challenging',
			'setup.aiAdaptiveDesc': 'Learns you',
			'setup.playerAiShort': 'Type',
		...
		es: {
			...
			'setup.welcomeTitle': 'MONOPOLY',
			'setup.welcomeTagline': 'El clásico atemporal · Edición digital',
			...
			'setup.customizeFor': 'Personalizar — {player}',
			'setup.customizeDone': 'Listo',
			'history.title': 'Historial',
			'history.collapse': 'Colapsar historial',
			...
			'setup.presetsLabel': 'Dinero inicial:',
			'setup.editionClassicDesc': 'Boardwalk · Mediterránea · 1935',
			'setup.editionNYCDesc': 'Times Square · Wall Street · Moderna',
			'setup.startGameHero': 'JUGAR',
			'setup.startGameSubtitle': 'Empezar nueva partida',
			'setup.aiHumanDesc': 'Jugador real',
			'setup.aiEasyDesc': 'Aprendiendo',
			'setup.aiNormalDesc': 'Balanceada',
			'setup.aiHardDesc': 'Desafiante',
			'setup.aiAdaptiveDesc': 'Te aprende',
			'setup.playerAiShort': 'Tipo',
