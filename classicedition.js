// Classic edition. Square/Card/utiltext live in edition-common.js.
...
square[26] = new Square("Atlantic Avenue", "$260", "#E6C200", 260, 8, 22, 110, 330, 800, 975, 1150);
square[27] = new Square("Ventnor Avenue", "$260", "#E6C200", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("Water Works", "$150", "#FFFFFF", 150, 2);
square[29] = new Square("Marvin Gardens", "$280", "#E6C200", 280, 8, 24, 120, 360, 850, 1025, 1200);
